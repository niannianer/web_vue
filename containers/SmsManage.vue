        ...
        <div class="sms-wrap" flex-box="1" flex="dir:top">
            <div class="table-handle" flex-box="0">
                <div class="table-input" flex="main:justify">
                    ...
                    <dl flex>
                        <dt>短息内容：</dt>
                        <dd><b-form-input type="text" size="sm" v-model="smsText" placeholder="请输入短息内容"></b-form-input></dd>
                    </dl>
                    <dl flex>
                        <dt>类别：</dt>
    ...
    export default {
        ...
        data(){
            return {
                ...
                fields: {
                    etUuid: { label: '模板编号' },
                    experienceName:{label:'类别'},
                    experienceAmount: { label: '内容' },
                    annualInterestRate: { label: '添加时间' },
                    operation: { label: '操作' }
                },
                items:[],
                perPage:10,
